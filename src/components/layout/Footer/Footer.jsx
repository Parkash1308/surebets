  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.footerContent}>
        ...
        <div className={styles.footerBrand}>
          ...
          <a href="/" className={styles.logo}>
            Surebet<span className={styles.logoHighlight}>es</span> {/* Updated to Surebetes */}
          </a>
      ...
      <div className={styles.footerBottom}>
        <p>&copy; {new Date().getFullYear()} Surebetes. All rights reserved.</p> {/* Updated to Surebetes */}
        <p>Built with ❤️ by Surebetes</p> {/* Updated to Surebetes */}
      </div>
    </footer>
  );
};
